...
inline constexpr NGXResult NGX_SUCCESS = 0x1;
inline constexpr NGXResult NGX_FEATURE_NOT_FOUND = 0xBAD00004;
inline constexpr NGXResult NGX_INVALID_PARAMETER = 0xBAD00005;

inline constexpr uint32_t NGXHardcodedArchitecture = 0xC0;
