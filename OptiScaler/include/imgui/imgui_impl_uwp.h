...
IMGUI_IMPL_API bool
ImGui_ImplUwp_InitForSwapChainPanel(void* swapchain_panel); // ABI::Windows::UI::Xaml::Controls::ISwapChainPanel*
IMGUI_IMPL_API void ImGui_ImplUwp_Shutdown();
IMGUI_IMPL_API void ImGui_ImplUwp_NewFrame(ImVec2 displaySize);
